...
public class Task implements Comparable<Task> {
    ...
    public int compareTo(Task o) {
        ...
        if (result == 0) {  //same project
            result = this.description.compareTo(o.description); //sort by description
        }
        return result;
    }

    //////////////////////////////////////////////////////////////////////
    //  tasks = unique by project & description
    //////////////////////////////////////////////////////////////////////
    @Override
