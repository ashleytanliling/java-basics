...
public class MealOrder {
    ...
    //  composition (Has-A Burger, Has-An Item)
    ...
    public void printItemizedList() {
        burger.printItem();
        if (burger instanceof DeluxeBurger) {
            Item.printItem(drink.getName(), 0); //deluxe burger include free drink
            Item.printItem(side.getName(), 0);  //deluxe burger include free side
        } else {
            drink.printItem();
            side.printItem();
        }
