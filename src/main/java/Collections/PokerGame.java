...
public class PokerGame {
    ...
    public PokerGame(int playerCount, int cardsInHand) {
        ...
        pokerHands = new ArrayList<>(cardsInHand);  //set capacity to n(cardsInHand)
    }
    ...
    public void startPlay() {
        ...
        //remainingCards = new ArrayList<>(cardsRemaining);   //empty list, dun work
        //populate with null values -> else .replaceAll() dun work on empty list
    ...
    private void deal() {
        //2D array, 1 array for each player
        //deckIndex to cycle thro deck list, so as to distribute cards
